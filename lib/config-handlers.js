...
if (!params.arpar) {console.log("Autoremote config error: no arpar entered"); return;}
if (!params.snapshot_url) {console.log("Autoremote config error: no device key entered"); return;}

  var snapshot_url = "name:"+params.name+"=:=type:"+params.type+"=:=arpar:"+params.arpar+"=:=key:"+params.snapshot_url;
