...
exports.fetchIpModal = {
  "contents":[
    { "type":"paragraph", "text":"Please enter the name, arcomm string, device key and type for your Autoremote device"},
	{ "type":"paragraph", "text":""},
	{ "type":"input_field_text", "field_name": "name", "value": "", "label": "Name", "placeholder": "", "required": true},
	{ "type":"input_field_text", "field_name": "arcomm", "value": "", "label": "arcomm", "placeholder": "", "required": true},
    { "type":"input_field_text", "field_name": "snapshot_url", "value": "", "label": "Device key", "placeholder": "", "required": true},
	{ "type":"input_field_select", "field_name": "type", "label": "Send message or notification?", "options": [{ "name": "Message", "value": "message", "selected": true},{ "name": "Notification", "value": "notification", "selected": false}], "required": true },
    { "type":"paragraph", "text":""},
