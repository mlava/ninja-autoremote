...
function Device(snapshot_url,index,node,token,G) {
    ...
    this.AR_arpar = split_snapshot[2].slice(6);
...
//if (this.AR_type === "announcement") {
//var data = querystring.stringify({
//    message: this.AR_arpar+"=:=http://translate.google.com/translate_tts?tl=en&q=\""+escape(data)+"\"",
//    key: this.AR_key
//    });
//AR_type = "message";
//}
